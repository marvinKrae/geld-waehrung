...
\newcommand{\literaturUndGespraechsverzeichnis}{%
% Literaturverzeichnis + Gesprächsverzeichnis 
% (als Abschnitte unterhalb Kapitel Quellenverzeichnisse)
...
\printbibliography[heading=gespraeche,type=misc,keyword=gespraech,notkeyword=ausblenden]
}

\newcommand{\literaturverzeichnis}{%
% nur Literaturverzeichnis
% (als eigenes Kapitel ohne Überschrift Quellenverzeichnis)
\phantomsection
