...
\lstdefinelanguage{JavaScript}{
 keywords={typeof, exports, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break},
...
\usepackage[backend=biber,bibstyle=_dhbw_authoryear,citestyle=authoryear,uniquename=true,useprefix=true,bibencoding=utf8]{biblatex}
\input{dhbw_vorlagen/_dhbw_biblatex-config.tex} % mit DHBW-spezifischen Einstellungen
...
\input{dhbw_vorlagen/_dhbw_kopfzeilen.tex}		 % für schöne Kopfzeilen 
